...
- [PS2DQ5 カジノ検索ツール on Web](#ps2dq5-カジノ検索ツール-on-web)
  - [使い方](#使い方)
  - [参考文献](#参考文献)
    - [関連する他自分の資料](#関連する他自分の資料)
...
- [ドラクエ5[PS2]スロット出目表【検索用】ver.3.0(右弐さん)](https://uniright2.github.io/ancient/archives.html) - 自分の出目表のフォーマットの原型
- [出目表抜粋 : 腹黒パンダさん日記(腹黒パンダさん)](https://harapan.exblog.jp/16828130/) - 出目表を2～7の数字で表すアイデア

### 関連する他自分の資料

- [PS2DQ5カジノ検索モード for xyzzy](https://github.com/pingval/Speedrun/tree/master/DQ5/casino-mode) 機能的にはだいたい同じ
- [アンリミテッド:出目表](https://ss1.xrea.com/pingval.g1.xrea.com/ps2dq5/research/#unlimited-slot) ノーリセカジノ誰か
